...
export const SaludPublica = () => {
  return (
    <div className="container text-white py-4">
      <h2 className="fw-bold mb-1"><Icon name="ChartNoAxesCombined" className="me-2" />Salud Pública y Prevención</h2>
      ...
      <div className="list-group bg-dark border border-secondary rounded-3">
        <div className="list-group-item bg-dark text-white border-secondary p-3">
          <div className="d-flex w-100 justify-content-between">
            <h5 className="mb-1 text-warning"><Icon name="Syringe" className="me-2" />Campaña Vacunación Antigripal 2026</h5>
        ...
        <div className="list-group-item bg-dark text-white border-secondary p-3">
          <div className="d-flex w-100 justify-content-between">
            <h5 className="mb-1 text-info"><Icon name="Activity" className="me-2" />Prevención Ola de Calor</h5>
